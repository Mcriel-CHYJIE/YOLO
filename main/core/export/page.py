...
class ExportTab(QWidget):
    ...
    def _init_widgets(self):
        ...
        self._fmt.setView(_lv)
        self._fmt.setMaxVisibleItems(10)
        fm = self._fmt.fontMetrics()
        self._fmt.view().setMaximumHeight((fm.height() + 4) * 10 + 4)
        _lv2 = QListView()
        _lv2.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self._sz.setView(_lv2)
        self._sz.setMaxVisibleItems(10)
        fm2 = self._sz.fontMetrics()
        self._sz.view().setMaximumHeight((fm2.height() + 4) * 10 + 4)
